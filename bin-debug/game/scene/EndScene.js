...
var EndScene = (function (_super) {
    ...
    EndScene.prototype.initCatWin = function () {
        var bg = GameUtil.createBitmapByName("end_tip_fail_png");
        this.addChild(bg);
        ...
        sound.play(0, 1);
        var backBtn = GameUtil.createBitmapByName("btn_back_png");
        ...
        var replayBtn = GameUtil.createBitmapByName("btn_replay_png");
